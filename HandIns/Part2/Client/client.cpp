...
TSPoint processTouch() {
    ...
    */
    ...
    // Reassigns the mapped coordinates
    touch.x = touchX;
    touch.y = touchY;
...
void GenerateLetters() {
    ...
    COMPLEXITY
    O(x * y): Where x is number of columns, y is number of rows
    */
    ...
    // Randomly seeds the input based on the voltage at analog pin and time in microseconds into the program
    randomSeed(analogRead(RAND_PIN) + micros());
