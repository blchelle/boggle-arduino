...
const string dictFile = "words.txt";
...
void PrintBoard() {
    ...
    COMPLEXITY
    O(x*y), Where x is the number of cols, y is the number of rows
    */
...
void CheckWordReceived(string line) {
    ...
    COMPLEXITY
    O(s): Where s is the length of the input word
    */
...
void MakeTrie() {
    ...
    COMPLEXITY
    O(d) Where d is the size of dictionary
    */
...
void CreateBoard() {
    ...
    COMPLEXITY
    O(x*y), x is num colums, y is num rows
    */
